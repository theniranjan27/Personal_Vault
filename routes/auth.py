...
def verify_master():
    ...
    if not password_service.verify_password(master_password, user.master_password_hash):
    ...
    return jsonify({'success': True, 'redirect': url_for('auth.pin_page')})
